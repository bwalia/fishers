                ...
                Button {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 14)
                            .fill(form.isSelected(sport) ? Color.accentColor.opacity(0.16) : Color.secondary.opacity(0.08))
                    )
                    .overlay(
                        RoundedRectangle(cornerRadius: 14)
                            .strokeBorder(form.isSelected(sport) ? Color.accentColor : .clear, lineWidth: 2)
                    )
                    .foregroundStyle(form.isSelected(sport) ? Color.accentColor : Color.primary)
                }
                .buttonStyle(.plain)
            }
        }
                ...
                Button {
                    ...
                    HStack(alignment: .top, spacing: 12) {
                        Image(systemName: tier == option ? "largecircle.fill.circle" : "circle")
                            .foregroundStyle(tier == option ? Color.accentColor : .secondary)
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12)
                            .fill(tier == option ? Color.accentColor.opacity(0.12) : Color.secondary.opacity(0.07))
                    )
                }
                .buttonStyle(.plain)
            }
...
struct DivisionLadder: View {
    ...
    private func color(for division: Division) -> Color {
        ...
        if division.rank <= current.rank { return .accentColor }
        if let target, division.rank <= target.rank { return .accentColor.opacity(0.3) }
            ...
            ForEach(Weekday.pickerOrder) { day in
                ...
                Button {
                    ...
                    Text(day.shortLabel)
                        ...
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 10)
                        .background(isOn ? Color.accentColor : Color.secondary.opacity(0.12), in: RoundedRectangle(cornerRadius: 8))
...
struct ReliabilityRing: View {
    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                .trim(from: 0, to: reliability.fraction)
        ...
        .accessibilityLabel("Reliability \(reliability.score) out of 100, \(reliability.band.label)")
    }
}

#!/usr/bin/env bash
#
# load-ios-vault-secrets.sh — pull Fishers iOS signing material from Vault.
#
# Reads the flat KV v2 secret `secret/fishers/ios` (override with
# FISHERS_IOS_VAULT_PATH), materialises the ASC API key as a file, and exports
# identifiers for fastlane.
#

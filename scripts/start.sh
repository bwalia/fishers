...
# than having it baked in at build time. Leaving it out of this list meant a
# fully configured .env still reported `cards: false` and hid the card form.
for var in ANTHROPIC_API_KEY STRIPE_SECRET_KEY STRIPE_WEBHOOK_SECRET \
           NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY STRIPE_PUBLISHABLE_KEY \
           DLS_RESOURCE_TABLE OLLAMA_URL \
